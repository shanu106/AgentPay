...
// POST /api/payment/create-order - Create Razorpay order (supports single product or multi-item cart)
app.post(['/api/payment/create-order', '/api/orders'], async (req, res) => {
  try {
