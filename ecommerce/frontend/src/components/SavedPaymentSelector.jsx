...
export function SavedPaymentSelector({ selectedMethod, onSelectMethod, userEmail = 'nawaz@gmail.com' }) {
  ...
  return (
    <div style={{
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              fontWeight: '700',
              cursor: 'pointer',
              background: activeCategory === tab.id ? '#0284c7' : 'rgba(255, 255, 255, 0.06)',
      ...
      {statusMsg && (
        <div style={{ marginTop: '6px', fontSize: '11px', color: '#34d399', fontWeight: '600', textAlign: 'center' }}>
          ✓ {statusMsg}
        </div>
      )}
    </div>
